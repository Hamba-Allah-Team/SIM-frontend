'use client' // Dibuat client component karena menggunakan Dialog dari shadcn/ui
...
export default function ActivityCard({ item }: { item: KegiatanItem }) {
    return (
        <div className="bg-white p-6 rounded-xl shadow-lg flex items-center gap-6 hover:shadow-xl transition-shadow">
            ...
            <Dialog>
                <DialogTrigger asChild>
                    <Button variant="outline" className="bg-white border-[#FF9357] text-[#FF9357] hover:bg-[#FF9357]/10 hover:text-[#FF9357] rounded-full px-6">
                        Lihat Detail
                    </Button>
                </DialogTrigger>
