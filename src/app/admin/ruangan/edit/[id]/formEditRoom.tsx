...
const formSchema = z.object({
  ...
  capacity: z.coerce.number().int().min(1, "Kapasitas harus lebih dari 0"),
  facilities: z.string().min(1, "Fasilitas tidak boleh kosong"),
...
export default function FormEditRoom() {
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    ...
    if (deleteImage) {
      ...
      // Append the actual file object if a new one is selected
