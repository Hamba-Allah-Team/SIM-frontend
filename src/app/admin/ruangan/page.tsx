...
export default function RoomPage() {
    ...
    const handleDataDeletion = (roomId: number) => {
        ...
        setFilteredData((prevData) => prevData.filter((room) => room.room_id !== roomId));
    }
                        ...
                        return (
                            <div className="flex gap-4 justify-center">
                                <button
                                    ...
                                    onClick={() => { handleShowDetail(room.room_id) }}
                                >
                                ...
                                <button
                                    ...
                                    onClick={() =>  router.push(`/admin/ruangan/edit/${room.room_id}`)}
                                >
    ...
    return (
        <div className="w-full max-w-screen-xl min-h-screen px-2 sm:px-4 py-4 mx-auto">
              <div className="flex flex-wrap items-center justify-between mb-4 gap-4">
                    <h1 className="text-[28px] font-bold font-poppins text-black">Ruangan Masjid</h1>
