...
export const columns: ColumnDef<Reservation>[] = [
  ...
  },
  {
    ...
    header: ({}) => (
      <div className="text-center w-fit truncate mx-auto">
        <Button variant="ghost" className="font-semibold mx-auto items-center">
          Nama Ruangan
        </Button>
      </div>
    ),
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="text-center w-full">
        {new Date(row.getValue("reservation_date")).toLocaleDateString(
          "id-ID",
          {
            year: "numeric",
            month: "long",
  ...
  },
  {
    ...
    // cell-nya juga dikontrol dari ReservationPage.tsx
  },
];
