...
export default function GuestNewsList({ mosque_id, mosqueName }: GuestNewsListProps) {
  ...
  const fetchBerita = async () => {
    ...
    try {
      ...
      const filtered = data.data
        .filter((item: { contents_type: string }) => item.contents_type === "berita");
      ...
      setError(error.message || "Terjadi kesalahan saat memuat berita");
    } finally {
      setLoading(false);
    }
  };
