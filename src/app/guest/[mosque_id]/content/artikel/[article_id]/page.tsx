...
export default function GuestArticleDetail() {
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-10">
        <button
          ...
          onClick={() => router.push(`/guest/${mosque_id}/content/artikel`)}
        >
          <MoveLeft size={22} />
          <span>Kembali</span>
        </button>
    ...
    <div className="max-w-5xl pt-6 mx-auto p-6 space-y-12">
      ...
      {/* 3 Card kecil dalam 1 baris */}
        ...
        <div className="flex-1 bg-gray-200 p-4 rounded-xl shadow flex items-center gap-3 text-black">
            ...
            <p className="font-semibold capitalize text-black">{article.contents_type}</p>
            </div>
        </div>
        </div>
