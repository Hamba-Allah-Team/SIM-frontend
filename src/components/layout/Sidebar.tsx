...
function getMenuByRole(role: string): MenuItem[] {
    ...
    return isSuperadmin
        ...
        : [
            ...
            { label: "Kategori", icon: <Shapes size={18} />, href: "/admin/kategori" },
        ...
        <div className="sticky top-0 h-screen p-4">
            <div className="relative h-full">
                <button
                    ...
                    className="absolute -right-3 top-6 z-10 bg-white border border-slate-200 rounded-full p-1 shadow-md hover:bg-gray-50 transition text-black"
                >
